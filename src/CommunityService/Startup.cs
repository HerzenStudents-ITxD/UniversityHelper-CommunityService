...
using UniversityHelper.CommunityService.Models.Dto.Configurations;
...
namespace UniversityHelper.CommunityService
{
  public class Startup : BaseApiInfo
  {
    ...
    public Startup(IConfiguration configuration)
    {
      ...
      Version = "2.0.2.0";
      Description = "CommunityService is an API intended to work with the communities.";
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      services.AddDbContext<CommunityServiceDbContext>(options =>
      {
